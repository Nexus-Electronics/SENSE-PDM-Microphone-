...
Added Decibel Output Conversion
By Nexus Electronics 

Change PDM pins on line 18
...
//Serial.print(avgvolume);Serial.print(","); // print raw volume data 

//print decibels 
double db = 0;
db = -32.5 + 10.4 * log(avgvolume); // gathered decibel data using iphone app in addition to SENSE microphone data. created excel sheet and found trendline of data graph
